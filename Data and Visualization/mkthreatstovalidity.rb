...
filename="data/Unique_Threats_to_Validity.csv"
datadir="./figs/"
outputdir="diagrams/"
seperator="|"
...
auswahl=<<-eos
Threats To Validity:none,External Validity,Internal Validity,Construct Validity,Confirmability,Repeatability

Year:2017,2018,2019,2020,2021

eos

#texfile=outputdir+"threats_to_validity_histogram.tex"
#tex=open(texfile,"w+")
tex=nil
unless tex
 tex=STDOUT 
...
#texfile=outputdir+"threats_to_validity_pie.tex"
#tex=open(texfile,"w+")
tex=nil
unless tex
 tex=STDOUT 
...
auswahl=<<-eos
Year:2017,2018,2019,2020,2021|Threats To Validity:none,External Validity,Internal Validity,Construct Validity,Confirmability,Repeatability

eos

#texfile=outputdir+"threats_to_validity_stacked.tex"
#tex=open(texfile,"w+")
tex=nil
unless tex
 tex=STDOUT 
...
#texfile=outputdir+"threats_to_validity_portfolio.tex"
#tex=open(texfile,"w+")
tex=nil
unless tex
 tex=STDOUT 
