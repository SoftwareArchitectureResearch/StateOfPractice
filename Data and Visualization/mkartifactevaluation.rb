...
filename="data/Unique_Artifact_Evaluation.csv"
datadir="./figs/"
outputdir="diagrams/"
seperator="|"
...
auswahl=<<-eos
Tool Support:none,used,available

Input Data:none,used,available

Replication Package:none,yes

Artifacts:none,used,available,packaged

eos

#texfile=outputdir+"artifact_evaluation_histogram.tex"
#tex=open(texfile,"w+")
tex=nil
unless tex
 tex=STDOUT 
...
#texfile=outputdir+"artifact_evaluation_pie.tex"
#tex=open(texfile,"w+")
tex=nil
unless tex
 tex=STDOUT 
...
auswahl=<<-eos
Year:2017,2018,2019,2020,2021|Replication Package:none,yes
Year:2017,2018,2019,2020,2021|Tool Support:none,used,available
Year:2017,2018,2019,2020,2021|Input Data:none,used,available
Year:2017,2018,2019,2020,2021|Artifacts:none,used,available,packaged

Package:no,yes

eos

#texfile=outputdir+"artifact_evaluation_stacked.tex"
#tex=open(texfile,"w+")
tex=nil
unless tex
 tex=STDOUT 
...
auswahl.each_line do|line|
 ...
 #input h_values,x_keys,y_keys,ary[0],ary[2]
...
#texfile=outputdir+"artifact_evaluation_portfolio.tex"
#tex=open(texfile,"w+")
tex=nil
unless tex
 tex=STDOUT 
